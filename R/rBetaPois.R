...
#' @param alpha A positive value, the alpha shape parameter of beta distribution
#' estimated by using \link[Canopy2]{get_burstiness_bpsc},
#' \link[Canopy2]{get_burstiness_scale}, or other method of the user's choosing.
#' @param beta A positive value, the beta shape parameter of beta distribution
#' estimated by using \link[Canopy2]{get_burstiness_bpsc},
#' \link[Canopy2]{get_burstiness_scale}, or other method of the user's choosing.
